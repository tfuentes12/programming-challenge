var app = angular.module('users')
  .controller('UserController', ['userService', 'messageService', '$mdSidenav', '$timeout', '$scope', '$q', '$route', function(userService, messageService, $mdSidenav, $timeout, $scope, $q, $route) {
